...
_{{ cookiecutter.project_slug}}_ is in scope for security auditing as it is a library with the
...
<https://github.com/{{ cookiecutter.github_repo }}/{{ cookiecutter.project_slug }}/issues>.

### In GitHub

1. Open <https://github.com/{{ cookiecutter.github_repo }}/{{ cookiecutter.project_slug }}/issues>.
2. Click on _New Issue_ and fill out the following fields:
   ...
   - Add a description: For example,
      ...
      in `{{ cookiecutter.project_slug }}/backends/postgres.py line 423`
      ```

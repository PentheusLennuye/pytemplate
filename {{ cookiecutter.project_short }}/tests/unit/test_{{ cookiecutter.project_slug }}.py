...
test_{{ cookiecutter.project_slug }}.py Copyright {{ cookiecutter.year }} {{ cookiecutter.full_name }}
...
This test ensures that python unit testing works. Once the stub _{{ cookiecutter.project_slug }}.py_
file is modified, this test can be deleted.
"""

from unittest import TestCase
from {{ cookiecutter.project_slug }} import {{ cookiecutter.project_slug }} as t
